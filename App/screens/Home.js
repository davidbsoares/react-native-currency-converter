    ...
    <View style={styles.container}>
      ...
      <ScrollView scrollEnabled={scrollEnabled}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.textHeader}>Conversor de Moedas</Text>
          ...
          {isLoading ? (
            ...
            <Text style={styles.text}>
              {`1 ${baseCurrency} = ${conversionRate} ${quoteCurrency} em ${date && format(
                new Date(date),
                'dd/MM/yyyy'
              )}`}
            </Text>
            <Button text="Trocar Moedas" onPress={() => swapCurrencies()} />
            </>
